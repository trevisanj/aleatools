...
if __name__ == "__main__":
    ...
    k = a107.Console("starme0", S, args.datadir)
    k.run()

    # for i in range(50000):
    #     S.spawn()
    #
    # img = S._make_image(False)
    # img.show()
    #
    # if False:
    #     ii = 0
    ...
    #         ii += 1
    #         if ii == 100:
    #             print(a107.format_progress(i, N))
    #             ii = 0
    #     # img = S._make_image(True)
    #     # img.convert("RGB").save("bg-in.jpg")
    #     # img.show()
    #     # img = S._make_image(False)
    #     # img.convert("RGB").save("bg-out.jpg")
    #     # img.show()
    #
    #
    # # img = S._make_image(False)
